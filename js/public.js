...
$(document).ready(function(){
  ...
  $('#search-form').submit(function(e){
    ...
    if(text.length > 0) {
      console.log(text);
$.getJSON('https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=b45a8ae6296dfa7fff1a3aa658d46b5b&text='+text+'&per_page=75&format=json&nojsoncallback=1', successCallback);
